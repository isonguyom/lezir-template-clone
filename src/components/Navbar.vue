<template>
  <nav
    class="navbar navbar-expand-lg text-start w-100 py-3 bg-white custom-navbar shadow-sm"
  >
    <div class="container">
      <a class="navbar-brand" href="#"
        ><img class="logo" src="../assets/images/logo-dark.png" alt=""
      /></a>
      <button
      ...
      >
        <ul class="navbar-nav me-auto mx-lg-auto">
          ...
          <li class="nav-item px-4 px-lg-3">
            <router-link :to="{ path: '/', hash: '#pricing' }" class="nav-link"
              >Pricing</router-link
            >
          </li>
          <li class="nav-item px-4 px-lg-3">
            <router-link :to="{ path: '/', hash: '#blog' }" class="nav-link"
              >Blog</router-link
            >
          </li>
          <li class="nav-item px-4 px-lg-3">
